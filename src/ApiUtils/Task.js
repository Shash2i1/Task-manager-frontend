...
class TaskFunctions{
    ...
    async addTask({userId,taskDetails}){
        try {
            const response = await axios.post(`/api/v1/user/add-task`,{userId, taskDetails});
    ...
    async updatetask({taskId,taskDetails}){
        try {
            const response = await axios.post(`/api/v1/user/update-task`,{taskId,taskDetails});
            return response.data;
        } catch (error) {
    ...
    async deleteTask({taskId}){
        try {
            await axios.post(`/api/v1/user/delete-task`,{taskId})
        } catch (error) {
    ...
    async fetchTasks(){
        try {
            const response = await axios.get(`/api/v1/user/fetch-tasks`);
            return response
        } catch (error) {
